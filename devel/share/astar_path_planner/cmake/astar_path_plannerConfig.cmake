...
if("TRUE" STREQUAL "TRUE")
  set(astar_path_planner_SOURCE_PREFIX /home/jiangpin/projects/homework/Homework_ysh-ljp/src/astar_path_planner)
  set(astar_path_planner_DEVEL_PREFIX /home/jiangpin/projects/homework/Homework_ysh-ljp/devel)
  ...
  set(astar_path_planner_INSTALL_PREFIX /home/jiangpin/projects/homework/Homework_ysh-ljp/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer '1 <1@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'astar_path_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jiangpin/projects/homework/Homework_ysh-ljp/src/astar_path_planner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT astar_path_planner_NUM_DUMMY_TARGETS)
      set(astar_path_planner_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::astar_path_planner::wrapped-linker-option${astar_path_planner_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR astar_path_planner_NUM_DUMMY_TARGETS "${astar_path_planner_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::astar_path_planner::wrapped-linker-option${astar_path_planner_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND astar_path_planner_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jiangpin/projects/homework/Homework_ysh-ljp/devel/lib;/home/jiangpin/projects/homework/Homework_ysh-ljp/devel/lib;/home/jiangpin/projects/Multi-Robot-SLAM/Multi-Robot-LIO/devel/lib;/opt/ros/noetic/lib)
...
set(astar_path_planner_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(astar_path_planner_EXPORTED_TARGETS ${${astar_path_planner_dep}_EXPORTED_TARGETS})
endforeach()
